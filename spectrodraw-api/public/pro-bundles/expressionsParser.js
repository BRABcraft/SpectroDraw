...
parseExpression.vars = {
  ...
  "brush.effect.panTexture": () => document.getElementById("brushPanTexture").value,
  "brush.effect.panShift": () => parseFloat(sliders[30][0].value),
  "brush.effect.panStrength": () => parseFloat(sliders[31][0].value),
  "brush.effect.panBand": () => parseFloat(sliders[32][0].value),
  "eqBands": () => eqBands,
